...
// Cloud iot details.
const char* project_id = "by-temp-sensors";
...
#include "../certs/sensor-node-01.h"
// #include "../certs/sensor-node-03.h"
// #include "../certs/sensor-node-04.h"

// Time (seconds) to expire token += 20 minutes for drift
const uint16_t jwt_exp_secs = 3600; // Maximum 24H (3600*24)
